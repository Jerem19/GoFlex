<div class="row mt col-lg-12 form-panel">
    <form class="form-horizontal style-form" id="formAddInstallation" method="post">
        <label class="control-label col-sm-4"><?= L10N['index']['addInstallation']['macAddress']?></label><input class="col-sm-8 form-control" name="mac" />

        <label class="control-label col-sm-4"><?= L10N['index']['addInstallation']['name']?></label><input style="margin-bottom: 20px;" class="col-sm-8 form-control" name="name" />
