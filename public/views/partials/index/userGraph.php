            ...
            <div class="form-group">
                ...
                <div class="col-sm-12">
                    ...
                    <div>
                        ...
                        <div id="consumptionElect" style="width: calc(100% - 15px); text-align: center;"></div>
                    </div>
                    ...
                    <div>
                        ...
                        <div id="hotwaterTemperature" style="width: calc(100% - 15px); text-align: center;"></div>
                    </div>
                    ...
                    <div>
                        ...
                        <div id="consumptionHeatPump" style="width: calc(100% - 15px); text-align: center;"></div>
                    </div>
                    ...
                    <div>
                        ...
                        <div id="insideTemp" style="width: calc(100% - 15px); text-align: center;"></div>
                    </div>
                    ...
                    <div>
                        ...
                        <div id="productionElect" style="width: calc(100% - 15px); text-align: center;"></div>
                    </div>
                </div>
            </div>
        </fieldset>
